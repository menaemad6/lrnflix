...
const HeroBottomSection: React.FC<HeroBottomSectionProps> = ({ cta, socialIcons, avatars }) => (
  <div className="bg-background dark:bg-black px-4 py-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between md:px-8 lg:px-16 lg:py-8 lg:gap-8">
    {cta}
